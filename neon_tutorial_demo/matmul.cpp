    ...
    for (int i_idx = 0; i_idx < n; i_idx += 4) {
        for (int j_idx = 0; j_idx < m; j_idx += 4) {
            ...
            for (int k_idx = 0; k_idx < k; k_idx += 4) {
                ...
                C0 = vfmaq_laneq_f32(C0, A0, B0, 0); // C0 = C0 + A0 * B0[0]
                C0 = vfmaq_laneq_f32(C0, A1, B0, 1); // C0 = C0 + A1 * B0[1]
...
int main() {
    ...
    printf("all neon time: %f\n", elapsed2);

    printf("c_speed/neon_speed: %f\n", elapsed1 / (elapsed2 + 1e-12));
