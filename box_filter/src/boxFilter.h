...
public:
  ...
  void fastFilterV1(float *input, int radius, int height, int width, float *output);
  ...
  void fastFilterV2NeonAsmV1(float *input, int radius, int height, int width, float *output);
